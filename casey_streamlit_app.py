...
def main():
    ...
    selected_model = st.sidebar.radio("Select Model", ("Linear Regression", "Linear Regression w/ Neural Network" ))
    ...
    if stock_symbol:
        try:
            ...
            if selected_model == "Linear Regression w/ Neural Network":
                ...
                model_filename = "./testing/pickledModels/lrTensorFlow.pkl"                
            # elif selected_model == "Random Forest":
                ...
                model_filename = "./testing/pickledModels/grid_search_lr_model.pkl"                
